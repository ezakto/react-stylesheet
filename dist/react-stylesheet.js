...
},{"./lib/compile.js":4,"boolbase":1,"domutils":17}],3:[function(require,module,exports){
var falseFunc = require("boolbase").falseFunc;
...
},{"boolbase":1}],4:[function(require,module,exports){
/*
...
},{"./general.js":5,"./procedure.json":6,"./pseudos.js":7,"./sort.js":8,"boolbase":1,"css-what":9}],5:[function(require,module,exports){
...
},{"./attributes.js":3,"./pseudos":7}],6:[function(require,module,exports){
module.exports={
	"universal": 50,
	"tag": 30,
	"attribute": 1,
...
},{"./attributes.js":3,"boolbase":1,"nth-check":33}],8:[function(require,module,exports){
...
},{"./foreignNames.json":13,"domelementtype":15,"entities":27}],15:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
/**
...
},{"domelementtype":16}],20:[function(require,module,exports){
...
},{"domelementtype":16}],22:[function(require,module,exports){
var ElementType = require("domelementtype"),
...
},{"dom-serializer":14,"domelementtype":16}],23:[function(require,module,exports){
...
},{"./decode_codepoint":25,"./maps/entities.json":29,"./maps/legacy.json":30,"./maps/xml.json":31}],25:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"./maps/decode.json":28}],26:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"./maps/entities.json":29,"./maps/xml.json":31}],27:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./decode":24,"./encode":26}],28:[function(require,module,exports){
...
},{"boolbase":1}],33:[function(require,module,exports){
...
},{"./compile.js":32,"./parse.js":34}],34:[function(require,module,exports){
module.exports = parse;
...
function weight(selector) {
  var ids = (selector.match(/#/g) || []).length;
  var attrs = (selector.match(/\.|\[[^]+\]/g) || []).length;
  var tags = (selector.match(/(^|\s)[a-z]/g) || []).length;
  return ids * 100 + attrs * 10 + tags;
}

function getAdapter(_parents) {
  return {
    ...
    getAttributeValue: function getAttributeValue(elem, name) {
      return elem.props[(0, _utils.camelizeAttr)(name)];
    },
    getChildren: function getChildren(node) {
      var children = [];

      _react["default"].Children.forEach(node.props.children, function (child) {
        return child && children.push(child);
      });
    ...
    getSiblings: function getSiblings(node) {
      ...
      var parent = _parents.get(node);

      _react["default"].Children.forEach(parent.props.children, function (child) {
        return child && siblings.push(child);
      });
    ...
    removeSubsets: function removeSubsets(nodes) {
      ...
      while (--idx >= 0) {
        ...
        for (var ancestor = _parents.get(node); ancestor; ancestor = _parents.get(ancestor)) {
          if (nodes.indexOf(ancestor) > -1) {
            nodes.splice(idx, 1);
            break;
          }
    ...
    findAll: function findAll(test, nodes) {
      var matched = [];
      var stack = nodes.slice();

      var _loop = function _loop() {
        var elem = stack.shift();
        if (!elem || !elem.type) return "continue";
        var children = [];

        _react["default"].Children.forEach(elem.props.children, function (child) {
          return child && children.push(child);
        });
...
function getTagAndPropsFromSelector(selector) {
  var parts = (0, _cssWhat["default"])(selector).shift();
  var props = {};
  var tagName = 'div';
  parts.forEach(function (part) {
    switch (part.type) {
      ...
      case 'attribute':
        props[(0, _utils.camelizeAttr)(part.name)] = part.value;
        break;
...
function parseCSSObject(object) {
  var rules = [];
...
function parseCSSString(css) {
  ...
  css.split(/}\s*/).forEach(function (rule) {
    var _rule$split = rule.split(/\s*{\s*/),
        ...
        declarations = _rule$split2[1];

    if (!selector || !declarations) return;
    var style = {};
    declarations.split(/\s*;\s*/).forEach(function (declaration) {
...
function stringifyCSS(css) {
  return Object.entries(css).map(function (_ref3) {
    var _ref4 = _slicedToArray(_ref3, 2),
        className = _ref4[0],
        styles = _ref4[1];

    return ".".concat(className, "{").concat(Object.entries(styles).map(function (_ref5) {
      var _ref6 = _slicedToArray(_ref5, 2),
          k = _ref6[0],
          v = _ref6[1];

      return "".concat((0, _utils.decamelize)(k), ":").concat(v);
    }).join(';'), "}");
  }).join('');
}

},{"./utils":37,"css-what":10,"react":"react"}],36:[function(require,module,exports){
"use strict";
...
function indexParents(parent, children) {
...
function applyStyles(elem, rules, config) {
  ...
  rules.forEach(function (rule) {
    try {
      ...
      if (_cssSelect["default"].is(elem, selector, {
        adapter: adapter
      })) {
        if (pseudo) {
  ...
  if (children) {
    newProps.children = _react["default"].Children.map(children, function (child, idx) {
      return applyStyles(child, rules, _objectSpread({}, config, {
        styleId: "".concat(styleId, "_").concat(idx)
      }));
    });
  }

  return _react["default"].cloneElement(elem, newProps);
}

function StyleSheet() {
  var isObject = Object.prototype.toString.call(arguments.length <= 0 ? undefined : arguments[0]) === '[object Object]';
  var rules = isObject ? (0, _css.parseCSSObject)(arguments.length <= 0 ? undefined : arguments[0]) : (0, _css.parseCSSString)(String.raw.apply(String, arguments));
  var styleElement = document.createElement('style');
  var styleSheetId = Math.random().toString(36).slice(2);
  ...
  var hoc = function hoc(_ref3) {
    ...
    var adapter = (0, _css.getAdapter)(indexParents({
      props: {
        children: children
      }
    }, children));
    ...
    var result = _react["default"].Children.map(children, function (child, idx) {
      return applyStyles(child, rules, {
        styleId: "_".concat(styleSheetId, "_").concat(idx),
    ...
    _react["default"].useEffect(function () {
      return inline ? undefined : function () {
        return document.querySelector('head').removeChild(styleElement);
      };
    }, [inline]);
  ...
  hoc.styled = function (selector, extraProps, bindProps) {
    ...
    var _getTagAndPropsFromSe = (0, _css.getTagAndPropsFromSelector)(selector),
        ...
        props = _getTagAndPropsFromSe.props;
...
},{"./css":35,"./utils":37,"css-select":2,"react":"react"}],37:[function(require,module,exports){
"use strict";
...
exports.camelizeAttr = camelizeAttr;
...
function decamelize(string) {
  return string.replace(/[a-z][A-Z]/g, function (match) {
    return "".concat(match[0], "-").concat(match[1].toLowerCase());
  });
}

function camelizeAttr(string) {
  var camelCased = camelize(string);
